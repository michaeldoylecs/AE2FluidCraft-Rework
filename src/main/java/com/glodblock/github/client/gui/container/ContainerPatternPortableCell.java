...
public class ContainerPatternPortableCell extends ContainerFluidPatternTerminal {
    ...
    public ContainerPatternPortableCell(InventoryPlayer ip, IWirelessTerminal monitorable) {
