...
public class GuiBaseFluidPatternTerminalEx extends GuiItemMonitor {
    ...
    protected void actionPerformed(final GuiButton btn) {
        ...
        if (this.encodeBtn == btn) {
            ...
            FluidCraft.proxy.netHandler.sendToServer(
                    new CPacketFluidPatternTermBtns("PatternTerminalEx.beSubstitute", "1"));
        } else if (ModAndClassUtil.isBeSubstitutionsButton && beSubstitutionsEnabledBtn == btn) {
            FluidCraft.proxy.netHandler.sendToServer(
                    new CPacketFluidPatternTermBtns("PatternTerminalEx.beSubstitute", "0"));
        }
    }
