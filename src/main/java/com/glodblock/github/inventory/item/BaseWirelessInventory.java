...
import static com.glodblock.github.common.item.ItemMagnetCard.modeKey;
...
public abstract class BaseWirelessInventory extends MEMonitorHandler implements IWirelessTerminal, IWirelessExtendCard {
    ...
    protected ItemMagnetCard.Mode magnetMode = ItemMagnetCard.Mode.Off;;
    ...
    public BaseWirelessInventory(final ItemStack is, final int slot, IGridNode gridNode, EntityPlayer player,
        ...
        super(Objects.requireNonNull(Util.Wireless.getWirelessInv(is, player, channel)));
    ...
    private void readFromNBT() {
        ...
        this.setMagnetCardMode(ItemMagnetCard.Mode.values()[data.getInteger(modeKey)]);
    ...
    @Override
    public void setMagnetCardMode(ItemMagnetCard.Mode mode) {
        this.magnetMode = mode;
    }

    @Override
    public ItemMagnetCard.Mode getMagnetCardMode() {
        return this.magnetMode;
    }

    public void setMagnetCardNextMode() {
        setMagnetCardMode(
                ItemMagnetCard.Mode.values()[(getMagnetCardMode().ordinal() + 1)
                        % ItemMagnetCard.Mode.values().length]);
    }
